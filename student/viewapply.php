...
<body>
    ...
    <img src="../images/regbg.png" id="img1">
    	<?php include_once 'includes/nav.php' ?>
    <div class="content" style="margin-left: 170px; top: 250px;" >  
    
    	<div class="form-row">
    		<div class="form-text"><h1 style="margin-left: 100px;">Companies Applied</h1></div>
    	</div>
       <div class="form-text" style="margin-left: 250px; margin-top: 10px;">
        <a href="category.php" class="btn btn-sm btn-danger">Apply Now</a></div>
    	 <br>
    	<?php 
